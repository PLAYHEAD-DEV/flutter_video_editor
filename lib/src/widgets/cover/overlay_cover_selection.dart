...
class OverlayCoverSelection extends StatefulWidget {
  /// Slider that allow to select a generated cover
  const OverlayCoverSelection({
    super.key,
  ...
  @override
  State<OverlayCoverSelection> createState() => _OverlayCoverSelectionState();
}

class _OverlayCoverSelectionState extends State<OverlayCoverSelection>
